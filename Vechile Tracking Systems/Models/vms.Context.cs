...
namespace Vechile_Tracking_Systems.Models
{
    ...
    public partial class DFLDBEntiti : DbContext
    {
        public DFLDBEntiti()
            : base("name=DFLDBEntiti")
        {
        }
        ...
        public virtual int SP_DeviceLocation(string userName, string processType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_DeviceLocation", userNameParameter, processTypeParameter);
        }
    
        public virtual ObjectResult<SP_DriverList_Result> SP_DriverList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_DriverList_Result>("SP_DriverList");
        }
    
        public virtual ObjectResult<SP_GetVehicleDetailByQR_Result> SP_GetVehicleDetailByQR(string qrCode)
        {
            var qrCodeParameter = qrCode != null ?
                new ObjectParameter("QrCode", qrCode) :
                new ObjectParameter("QrCode", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GetVehicleDetailByQR_Result>("SP_GetVehicleDetailByQR", qrCodeParameter);
        }
        ...
        public virtual int SP_InsertActivityLog(string qRCodeNo, string activityType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_InsertActivityLog", qRCodeNoParameter, activityTypeParameter);
        }
        ...
        public virtual int SP_InsertLoadingActivity(string dateTime, string qRCodeNo, string activityType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_InsertLoadingActivity", dateTimeParameter, qRCodeNoParameter, activityTypeParameter);
        }
        ...
        public virtual int SP_InsertWeight(string vehicleNo, string qrCode, string weighmentDetails)
        {
            var vehicleNoParameter = vehicleNo != null ?
                new ObjectParameter("VehicleNo", vehicleNo) :
                new ObjectParameter("VehicleNo", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_InsertWeight", vehicleNoParameter, qrCodeParameter, weighmentDetailsParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> SP_MfgYearList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("SP_MfgYearList");
        }
        ...
        public virtual ObjectResult<SP_SelectSelectDriver_Result> SP_SelectSelectDriver()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SelectSelectDriver_Result>("SP_SelectSelectDriver");
        }
        ...
        public virtual ObjectResult<SP_VehicleQRCode_Result> SP_VehicleQRCode()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_VehicleQRCode_Result>("SP_VehicleQRCode");
        }
    
        public virtual ObjectResult<SP_DeviceLocate_Result> SP_DeviceLocate(string userName, string processType)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_DeviceLocate_Result>("SP_DeviceLocate", userNameParameter, processTypeParameter);
        }
    }
}
